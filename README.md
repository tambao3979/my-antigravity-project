...
### 💻 Chạy giao diện dòng lệnh (CLI gốc)

Nếu bạn không muốn dùng giao diện, bạn có thể chạy bằng dòng lệnh:
```bash
python main.py
```

Khi chạy, chương trình sẽ hiển thị menu cho phép chọn nguồn video:
```
============================================================
   CHỌN NGUỒN VIDEO ĐỂ DỰ ĐOÁN
============================================================
1. Camera (Webcam/USB)
2. File Video (.mp4, .avi, ...)
3. RTSP / Stream URL
============================================================
Lựa chọn của bạn (1-3) [mặc định: 1]:
```
Bạn chỉ cần chọn nguồn, nhập ID/Đường dẫn/URL và tiếp tục.
